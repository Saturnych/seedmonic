import { PUBLIC_APP_NAME, PUBLIC_ENV } from '$env/static/public';

const ENV = Object.assign({}, import.meta.env);

export const NODE_ENV: string = PUBLIC_ENV ?? ENV.NODE_ENV ?? ENV.VITE_USER_NODE_ENV ?? ENV.MODE ?? '';
...
export const APP_NAME: string = PUBLIC_APP_NAME ?? ENV.APP_NAME ?? 'App';
